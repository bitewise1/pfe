...
const EstimationScreen = ({ route }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.userNameEstim}>{user?.firstName}'s Plan</Text>
        <View style={styles.userStats}>
          <Text style={styles.statText}>Goal: {user?.goal}</Text>
          <Text style={styles.statText}>Activity: {user?.activityLevel}</Text>
        </View>
      </Animated.View>
